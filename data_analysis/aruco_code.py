...
def do_aruco(cv_image,steering_cmd,motor_cmd,ar_params, crop=False):
    ...
    safe_motor, safe_steer = marker.add_evasion_behaviour(cv_image,steering_cmd,motor_cmd,ar_params,crop) 

    # For debug purposes lets say that evasion is always needed
    evasion_needed = True

    #("Hey: " + str(safe_motor) + " , " + str(safe_steer))
